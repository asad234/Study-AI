    ...
    if (currentQuestionType === 'multiple_choice') {
      return (
        <div className="space-y-3">
          <Label className="text-sm font-medium">Alternatives <span className="text-red-500">*</span></Label>
          <p className="text-xs text-gray-500">
            Select one radio button to indicate the correct answer.
          </p>
          <RadioGroup 
      ...
      return (
        <div className="space-y-2">
          <Label htmlFor="openEndedAnswer">Correct Answer <span className="text-red-500">*</span></Label>
          <Textarea
            id="openEndedAnswer"
      ...
      <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
        ...
        <DialogContent className="sm:max-w-[1000px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Create your own custom quiz with multiple choice or open-ended questions.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="p-4 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Add questions and their corresponding answers.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
