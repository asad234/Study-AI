...
export default function DashboardPage() {
  const recentFiles = [
    { name: "Biology Chapter 5.pdf", type: "PDF", uploadedAt: "2 hours ago", status: "processed" },
    { name: "History Notes.docx", type: "DOCX", uploadedAt: "1 day ago", status: "processed" },
    { name: "Math Formulas.pptx", type: "PPTX", uploadedAt: "3 days ago", status: "processing" },
  ]
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center gap-2 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-green-600 dark:text-green-400">You&apos;re on track to meet your weekly goal</p>
              </div>
            </div>
          </CardContent>
        </Card>
